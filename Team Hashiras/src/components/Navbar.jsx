...
export default function NavBar(props) {
  return (
    <div className="bg-pink-300 bg-opacity-30 flex flex-col justify-center items-stretch p-12 max-md:px-5">
      <div className="border backdrop-blur-[15px] bg-white bg-opacity-30 flex flex-col items-stretch pt-4 pb-4 pl-5 pr-12 rounded-3xl border-solid border-white max-md:max-w-full relative max-md:px-5">
 ...
 absolute rounded-full bg-yellow-500 opacity-20 z-[-10]"
            ...
            <img
              ...
              className="aspect-square object-contain object-center w-[220px] h-[100px] fill-neutral-600"
            />
            {/* <div className="text-neutral-600 text-2xl font-bold grow whitespace-nowrap pt-4 mt-2.5 self-start">
              Crime Detector
            </div> */}
          </div>
